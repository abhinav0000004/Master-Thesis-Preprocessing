# rename all c3d files in folder
param (
...
Get-ChildItem * | Rename-Item -NewName { $_.Name -replace '_human.', '_person.' } # some variations were misspelled as 'human' instead of 'person'
